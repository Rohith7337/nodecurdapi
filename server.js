...
const connectionString ="mongodb+srv://Rohith2:rohith@cluster0.0fjxu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
 ...
 .then(client => {
    ...
    //2. Reading data from MongoDB
       app.get('/getall',(req,res)=>{
            ...
            .then(result=>{
             res.send(result)   // res.render('index.ejs',{quotes:result})
            })
...
//Here we are trying to send index.html for frontend client request
//app.get('/',(req,res)=>{
